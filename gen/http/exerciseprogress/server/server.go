...
// Server lists the exerciseprogress service endpoint HTTP handlers.
type Server struct {
	Mounts []*MountPoint
	Create http.Handler
	Get    http.Handler
...
// New instantiates HTTP handlers for all the exerciseprogress service
...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"Create", "POST", "/api/v1/exerciseprogress"},
			{"Get", "GET", "/api/v1/exerciseprogress/{id}"},
			{"List", "GET", "/api/v1/exerciseprogress"},
			{"Update", "PUT", "/api/v1/exerciseprogress/{id}"},
			{"Delete", "DELETE", "/api/v1/exerciseprogress/{id}"},
		},
...
func (s *Server) Service() string { return "exerciseprogress" }
...
func (s *Server) MethodNames() []string { return exerciseprogress.MethodNames[:] }

// Mount configures the mux to serve the exerciseprogress endpoints.
...
// MountCreateHandler configures the mux to serve the "exerciseprogress"
...
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/api/v1/exerciseprogress", f)
}

// NewCreateHandler creates a HTTP handler which loads the HTTP request and
// calls the "exerciseprogress" service "create" endpoint.
func NewCreateHandler(
	...
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		ctx = context.WithValue(ctx, goa.ServiceKey, "exerciseprogress")
...
// MountGetHandler configures the mux to serve the "exerciseprogress" service
// "get" endpoint.
func MountGetHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/v1/exerciseprogress/{id}", f)
}

// NewGetHandler creates a HTTP handler which loads the HTTP request and calls
// the "exerciseprogress" service "get" endpoint.
func NewGetHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountListHandler configures the mux to serve the "exerciseprogress" service
// "list" endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/v1/exerciseprogress", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "exerciseprogress" service "list" endpoint.
func NewListHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
// MountUpdateHandler configures the mux to serve the "exerciseprogress"
...
func MountUpdateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("PUT", "/api/v1/exerciseprogress/{id}", f)
}

// NewUpdateHandler creates a HTTP handler which loads the HTTP request and
// calls the "exerciseprogress" service "update" endpoint.
...
// MountDeleteHandler configures the mux to serve the "exerciseprogress"
...
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/api/v1/exerciseprogress/{id}", f)
}

// NewDeleteHandler creates a HTTP handler which loads the HTTP request and
// calls the "exerciseprogress" service "delete" endpoint.

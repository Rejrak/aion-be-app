...
//
// workoutexercise HTTP server encoders and decoders
//
// Command:
// $ goa gen be/design
...
// workoutexercise create endpoint.
func EncodeCreateResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*workoutexercise.WorkoutExercise)
		enc := encoder(ctx, w)
...
func DecodeCreateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (any, error) {
	return func(r *http.Request) (any, error) {
		...
		payload := NewCreateWorkoutExercisePayload(&body)
...
// DecodeGetRequest returns a decoder for requests sent to the workoutexercise
// get endpoint.
...
// DecodeListRequest returns a decoder for requests sent to the workoutexercise
// list endpoint.
...
// workoutexercise update endpoint.
...
func DecodeUpdateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (any, error) {
	return func(r *http.Request) (any, error) {
		...
		payload := NewUpdateWorkoutExercisePayload(&body, id)
...
// workoutexercise delete endpoint.
...
// marshalWorkoutexerciseWorkoutExerciseToWorkoutExerciseResponse builds a
// value of type *WorkoutExerciseResponse from a value of type
// *workoutexercise.WorkoutExercise.
func marshalWorkoutexerciseWorkoutExerciseToWorkoutExerciseResponse(v *workoutexercise.WorkoutExercise) *WorkoutExerciseResponse {

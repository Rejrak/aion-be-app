...
//
// workouttype HTTP server encoders and decoders
//
// Command:
// $ goa gen be/design
...
func EncodeCreateResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*workouttype.WorkoutType)
		enc := encoder(ctx, w)
...
// DecodeCreateRequest returns a decoder for requests sent to the workouttype
// create endpoint.
func DecodeCreateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (any, error) {
	return func(r *http.Request) (any, error) {
		...
		payload := NewCreateWorkoutTypePayload(&body)
...
// DecodeGetRequest returns a decoder for requests sent to the workouttype get
// endpoint.
...
// DecodeListRequest returns a decoder for requests sent to the workouttype
// list endpoint.
...
// DecodeUpdateRequest returns a decoder for requests sent to the workouttype
// update endpoint.
func DecodeUpdateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (any, error) {
	return func(r *http.Request) (any, error) {
		...
		payload := NewUpdateWorkoutTypePayload(&body, id)
...
// DecodeDeleteRequest returns a decoder for requests sent to the workouttype
// delete endpoint.
...
// marshalWorkouttypeWorkoutTypeToWorkoutTypeResponse builds a value of type
// *WorkoutTypeResponse from a value of type *workouttype.WorkoutType.
func marshalWorkouttypeWorkoutTypeToWorkoutTypeResponse(v *workouttype.WorkoutType) *WorkoutTypeResponse {
	res := &WorkoutTypeResponse{
		ID:          v.ID,
		Name:        v.Name,

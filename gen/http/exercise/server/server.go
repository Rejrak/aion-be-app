...
func MountCreateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("POST", "/api/v1/exercises", f)
}
...
// MountGetHandler configures the mux to serve the "exercise" service "get"
// endpoint.
...
// MountListHandler configures the mux to serve the "exercise" service "list"
// endpoint.
func MountListHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("GET", "/api/v1/exercises", f)
}

// NewListHandler creates a HTTP handler which loads the HTTP request and calls
// the "exercise" service "list" endpoint.
func NewListHandler(
	endpoint goa.Endpoint,
	mux goahttp.Muxer,
	decoder func(*http.Request) goahttp.Decoder,
...
func MountUpdateHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("PUT", "/api/v1/exercises/{id}", f)
}
...
func MountDeleteHandler(mux goahttp.Muxer, h http.Handler) {
	...
	mux.Handle("DELETE", "/api/v1/exercises/{id}", f)
}

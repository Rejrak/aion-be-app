...
//
// musclegroup HTTP server encoders and decoders
//
// Command:
// $ goa gen be/design
...
func EncodeCreateResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, any) error {
	return func(ctx context.Context, w http.ResponseWriter, v any) error {
		res, _ := v.(*musclegroup.MuscleGroup)
		enc := encoder(ctx, w)
...
// DecodeCreateRequest returns a decoder for requests sent to the musclegroup
// create endpoint.
func DecodeCreateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (any, error) {
	return func(r *http.Request) (any, error) {
		...
		payload := NewCreateMuscleGroupPayload(&body)
...
// DecodeGetRequest returns a decoder for requests sent to the musclegroup get
// endpoint.
...
// DecodeListRequest returns a decoder for requests sent to the musclegroup
// list endpoint.
...
// DecodeUpdateRequest returns a decoder for requests sent to the musclegroup
// update endpoint.
func DecodeUpdateRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (any, error) {
	return func(r *http.Request) (any, error) {
		...
		payload := NewUpdateMuscleGroupPayload(&body, id)
...
// DecodeDeleteRequest returns a decoder for requests sent to the musclegroup
// delete endpoint.
...
// marshalMusclegroupMuscleGroupToMuscleGroupResponse builds a value of type
// *MuscleGroupResponse from a value of type *musclegroup.MuscleGroup.
func marshalMusclegroupMuscleGroupToMuscleGroupResponse(v *musclegroup.MuscleGroup) *MuscleGroupResponse {
	res := &MuscleGroupResponse{
		ID:          v.ID,
		Name:        v.Name,

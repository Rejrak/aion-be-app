...
// Service for managing workout exercise configuration
type Service interface {
	// Create a new workout exercise configuration
	Create(context.Context, *CreateWorkoutExercisePayload) (res *WorkoutExercise, err error)
	// Get a workout exercise configuration by ID
	Get(context.Context, *GetPayload) (res *WorkoutExercise, err error)
	// List all workout exercise configurations with pagination
	List(context.Context, *ListPayload) (res []*WorkoutExercise, err error)
	// Update a workout exercise configuration
	Update(context.Context, *UpdateWorkoutExercisePayload) (res *WorkoutExercise, err error)
...
// key.
const ServiceName = "workoutexercise"
...
// CreateWorkoutExercisePayload is the payload type of the workoutexercise
...
// DeletePayload is the payload type of the workoutexercise service delete
// method.
...
// GetPayload is the payload type of the workoutexercise service get method.
...
// ListPayload is the payload type of the workoutexercise service list method.
...
// UpdateWorkoutExercisePayload is the payload type of the workoutexercise
// service update method.
type UpdateWorkoutExercisePayload struct {
	// Workout Exercise ID
	ID string
	// Number of sets
	Sets int
...
// WorkoutExercise is the result type of the workoutexercise service create
// method.
